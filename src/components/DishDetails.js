...
export default function DishDetails() {
    ...
    const updateDish = () => {
        ...
        axios
            .put("/updateDish/" + selectedDish._id, {
                title: title,
    ...
    const deleteDish = (selectedDish) => {
        axios
            .delete("/deleteDish/" + selectedDish._id)
            .then((response) => {
                console.log(response);
                fetchDishes();
            })
        ...
        <>
            <div className="row">
                ...
                <p style={styling.paragraph}>
                    Here are details of our popluar dishes
                </p>
